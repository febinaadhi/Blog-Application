    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posts', to='blog_app.customuser')),
                ('likes', models.ManyToManyField(blank=True, related_name='liked_posts', to='blog_app.customuser')),
            ],
            options={
                'verbose_name': 'post',
